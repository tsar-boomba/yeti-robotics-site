...
const TwentyTwenty = () => {
	return (
		<Layout
			title='2020 Season'
			description='The 2020 season for tem 3506, YETI.'
			article={true}
		>
			<Title>2020 Season</Title>
			<StaticImage src='../../images/team-pics/2020-team.webp' alt='2020 team' width={512} />
			<p style={{ marginTop: 0, fontSize: '1.5rem' }}>The 2020 YETI team</p>
			<Section>
